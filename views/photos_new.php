...
<?php } ?>
<form enctype="multipart/form-data" method="post" action="/galerie/index.php/gallery/photos_add/<?=$album_name ?>">
  ...
  <a href="/galerie/index.php/gallery/albums_show/<?=$album ?>"  class="btn btn-danger">Annuler</a>
</form>